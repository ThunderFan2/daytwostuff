...
print(PATH)
# %%
print("I shouldn't include the environment in my repo")
...
# %%
print("The Extensions menu allows you to search and install tools directly inside VS Code and shows useful information like the publisher, ratings, and install count. Extensions can be enabled per each workspace, which makes it easy to customize VS Code for specific tasks.")

# %% 
print("Data Wrangler provides an interactive spreadsheet-style view of DataFrames, built-in data profiling to inspect types and missing values, and the ability to generate pandas code from transformations performed in the UI.")
# %%
print("Installed plotly Version: 6.5.1")

#%%
print("We use a requirements.txt file to list our project's dependencies and their precise versions, so it can be easily recreated on another machine.")